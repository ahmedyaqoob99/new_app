...
import 'package:news_app/helper/technology.dart';
...
class TechnologyWidget extends StatefulWidget {
  ...
  @override
  State<TechnologyWidget> createState() => _TechnologyWidgetState();
}

class _TechnologyWidgetState extends State<TechnologyWidget> {
  getNewsData() async {
    Technology newsClass = Technology();
                      ...
                      trailing: GestureDetector(
                          onTap: () {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                                content: Text(products.itemList.toString())));
                          },
                          child: const Icon(
                            Icons.favorite,
                            color: Colors.red,
